...
public:
    ...
    struct PositionVelocityLocal {
        ...
        float north_m_s; /**< @brief Velocity along north-direction of local frame in meters per seconds. */
        float east_m_s; /**< @brief Velocity along east-direction of local frame in meters per seconds. */
        float down_m_s; /**< @brief Velocity along down-direction of local frame in meters per seconds. */
    };
 ...
 */
bool operator==(const Telemetry::PositionVelocityLocal &lhs, const Telemetry::PositionVelocityLocal &rhs);
