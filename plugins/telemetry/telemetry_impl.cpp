...
void TelemetryImpl::set_rate_position_velocity_local_async(double rate_hz, Telemetry::result_callback_t callback)
{
...
void TelemetryImpl::process_position_velocity_local(const mavlink_message_t &message)
{
    ...
    set_position_velocity_local(Telemetry::PositionVelocityLocal({
    								  local_position.x,
									  local_position.y,
									  local_position.z,
									  local_position.vx,
...
void TelemetryImpl::set_position_velocity_local(Telemetry::PositionVelocityLocal position_velocity_local) {
	std::lock_guard<std::mutex> lock(_position_velocity_local_mutex);
...
void TelemetryImpl::position_velocity_local_async(Telemetry::position_velocity_local_callback_t &callback)
{
